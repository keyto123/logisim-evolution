...
class Video extends InstanceFactory {
	...
	public Video() {
		...
		Port[] ports = new Port[] { new Port(-220, 130, Port.INPUT, 1), new Port(-200, 130, Port.INPUT, 1),
				new Port(-140, 130, Port.INPUT, 7), new Port(-130, 130, Port.INPUT, 7),
				new Port(-120, 130, Port.INPUT, 16), new Port(-240, 130, Port.INPUT, 1) };
