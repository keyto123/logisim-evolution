...
import static edu.cornell.cs3410.SPIMUtils.ADDR;
import static edu.cornell.cs3410.SPIMUtils.BADVADDR;
import static edu.cornell.cs3410.SPIMUtils.BOX_HEIGHT;
import static edu.cornell.cs3410.SPIMUtils.BOX_WIDTH;
import static edu.cornell.cs3410.SPIMUtils.CAUSE;
import static edu.cornell.cs3410.SPIMUtils.CLK;
import static edu.cornell.cs3410.SPIMUtils.DIN;
import static edu.cornell.cs3410.SPIMUtils.DOUT;
import static edu.cornell.cs3410.SPIMUtils.EPC;
import static edu.cornell.cs3410.SPIMUtils.E_CODE_HW;
import static edu.cornell.cs3410.SPIMUtils.HEIGHT;
import static edu.cornell.cs3410.SPIMUtils.IRQ_IN;
import static edu.cornell.cs3410.SPIMUtils.KEYBOARD_IRQ;
import static edu.cornell.cs3410.SPIMUtils.LD;
import static edu.cornell.cs3410.SPIMUtils.NUM_REGISTERS;
import static edu.cornell.cs3410.SPIMUtils.OP;
import static edu.cornell.cs3410.SPIMUtils.PC;
import static edu.cornell.cs3410.SPIMUtils.SEL;
import static edu.cornell.cs3410.SPIMUtils.STATUS;
import static edu.cornell.cs3410.SPIMUtils.STR;
import static edu.cornell.cs3410.SPIMUtils.WIDTH;
import static edu.cornell.cs3410.SPIMUtils.boxX;
import static edu.cornell.cs3410.SPIMUtils.boxY;
import static edu.cornell.cs3410.SPIMUtils.cp_x;
import static edu.cornell.cs3410.SPIMUtils.cp_y;
import static edu.cornell.cs3410.SPIMUtils.drawBox;
import static edu.cornell.cs3410.SPIMUtils.drawCPBox;
...
public class SPIM extends InstanceFactory {
	...
	private class Staller {
		...
		public void step(Fetch fetch, Decode decode, Execute execute, Memory mem) {
			...
			if (((decode.inst.rs == execute.inst.rd)
					|| (decode.inst.rt == execute.inst.rd) && (decode.inst.is_immediate() == false))
					&& (execute.inst.is_load()) && (execute.inst.rd != 0)) {
			...
			if (((decode.inst.rs == mem.inst.rd)
					|| (decode.inst.rt == mem.inst.rd) && (decode.inst.is_immediate() == false)) && (mem.inst.is_load())
					&& (mem.inst.rd != 0)) {
	...
	private class Memory extends Stage {
		...
		private boolean is_mem_read() {
			if (inst.opcode == 121 || inst.opcode == 122 || inst.opcode == 125 || inst.opcode == 126
					|| inst.opcode == 130)
				return true;
			return false;
		}
